...
from src.layers.Attention import TwoStageAttentionLayer, MultiheadAttention
from src.utils.tools_bimamba import Transpose, get_activation_fn
...
class TSAEncoder(nn.Module):
    def __init__(
        ...
        self.TSA = TwoStageAttentionLayer(
...
class TSADecoder(nn.Module):
    ...
    def forward(self, x, cross):
        ...
        layer_predict = torch.reshape(
            dec_output, (self.batch_size, -1, dec_output.shape[1], dec_output.shape[2])
        )
